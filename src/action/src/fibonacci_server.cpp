...
typedef actionlib::SimpleActionServer<action::FibonacciAction> Server;
...
protected:
  ...
  action::FibonacciFeedback feedback_;
  action::FibonacciResult result_;
...
public:
  ...
  void executeCB(const action::FibonacciGoalConstPtr &goal)
  {
    // helper variables
    ros::Rate r(1);
    bool success = true;
